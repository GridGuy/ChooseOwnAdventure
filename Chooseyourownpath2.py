...
if start == "Start" or "start": 
		...
		if choice == "Hide":
			...
			if choicerid == "File":
				...
				print("You take your chance and hop out to escape, that is until you notice the the stange people fighting outside of Minas Tirith")
				...
				print("Two flying men, one in a suit of armor, the other with lightning arcing off his body, and others with outlandish a nd stange armaments, along with a tree person")
				...
				choicefof = (Choose your fate!)
				if choicefof == "Leave":
					print("You decide to leave this weird place and live on a mountain side cottage in the wilderness")
					print("A peaceful, quiet life is noiw the life for you after all the crazy you experienced when you broke free")
					...
					print("As you sneak up behind the large purple man, he then turns immediatly to you and grabs you by the face and yeets you half way across the planet")
