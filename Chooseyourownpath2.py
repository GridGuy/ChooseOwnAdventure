...
if start == "Start" or "start": 
		...
		if choice == "Hide" or "hide":
			...
			if choicea == "Orcs" or "orcs": #This choice leads to Cirith Ungol
				...
				if choiceb == "Darkness" or "darkness":  #You receive the Cloak of Darkness
					print("////////////////////////////////////")
